...
function Eventi() {
  const cardElements = database.slice(0, 1).map((el) => {
    return (
      <div className="col-md-6 d-flex justify-content-center my-5 py-5 section-card">
        <div className="card">
          <img
            src={`https://drive.google.com/uc?id=${el.imageID}`}
